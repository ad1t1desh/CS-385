...
# Version : og
# Date    : 10/26/2022
# Description : test file for inversioncounter.cpp
...
### my test cases ###
run_test_with_args_and_input "slow" "1" "Enter sequence of integers, each followed by a space: Number of inversions: 0" # only one value
run_test_with_args_and_input "slow" "1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 0" #having no inversions
run_test_with_args_and_input "slow" "3 1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 2"
run_test_with_args_and_input "slow" "5 4 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
...
run_test_with_args_and_input "slow" "1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "slow" "10 1 9 4 8 7 12" "Enter sequence of integers, each followed by a space: Number of inversions: 9"
run_test_with_args_and_input "slow" "0 0 19 12 89 3" "Enter sequence of integers, each followed by a space: Number of inversions: 4"
run_test_with_args_and_input "slow" "$(echo {100..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
# END slow tests
...
run_test_with_args_and_input "" "1" "Enter sequence of integers, each followed by a space: Number of inversions: 0" # only one value
run_test_with_args_and_input "" "1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 0" #having no inversions
run_test_with_args_and_input "" "3 1 2" "Enter sequence of integers, each followed by a space: Number of inversions: 2"
run_test_with_args_and_input "" "5 4 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
...
run_test_with_args_and_input "" "1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "" "0 0 19 12 89 3" "Enter sequence of integers, each followed by a space: Number of inversions: 4"
run_test_with_args_and_input "" "$(echo {100..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
